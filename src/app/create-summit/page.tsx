...
const CreateSummit = () => {
  ...
  const onSubmit = async (data: any) => {
    ...
    if (data && newSummit) {
      try {
        const response = await axios.post("/api/addSummit", {
          data: newSummit,
        });
      ...
      <DefaultLayout>
        <div className="flex justify-center items-center flex-col gap-5 h-dvh">
          <h2 className="text-3xl text-success">
            Summit successfully created 🎉.
          </h2>
          <button
            onClick={() => router.push(`/summits/${detailId}`)}
            type="button"
  ...
  return (
    <DefaultLayout>
      <div>
        <h2 className="text-4xl font-medium	text-center">Create Summit</h2>
        <div className="">
          <form
          ...
          >
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              ...
              <div className="relative z-0 w-full mb-5 group">
                <select
                  id="summitType"
                  {...register("summitType", { required: true })}
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                >
                  <option selected>Choose a summit type</option>
            ...
            <div className="mt-10">
              ...
              <div className="relative z-0 w-full mb-5 group">
                ...
                <label
                  ...
                  className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >
                  Summit organizer email (name@company.com)
                </label>
              </div>
            </div>
            {/* <div className="grid md:grid-cols-2 md:gap-6">
              <div className="relative z-0 w-full mb-5 group">
                ...
                <label
                  ...
                  className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >
                  Card image This'll be displayed on Summit Card. Recommended
                  size: 340x140
                </label>
              </div>
              <div className="relative z-0 w-full mb-5 group">
                ...
                <label
                  ...
                  className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                >
                  Card cover This'll be displayed on Summit Detail Page. 1270x290
                </label>
              </div>
            </div> */}
