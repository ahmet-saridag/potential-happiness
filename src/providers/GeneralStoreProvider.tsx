...
import { createGeneralStore } from "@/stores/useGeneralStore";

export const GeneralStoreContext = createContext<StoreApi<any> | null>(null);
...
export const useGeneralStore = <T,>(selector: (store: any) => T): T => {
